...
public class VKEntityConverter implements EntityConverter<UserFull> {

    @Override
    public Profile convertProfile(UserFull externalUser) {
    ...
    @Override
    public List<Profile> convertProfiles(List<UserFull> externalUsers) {
